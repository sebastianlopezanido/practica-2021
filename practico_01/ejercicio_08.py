...
def superposicion_basico(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    """
    for x in lista_1:           #Para cada elemento de la lista_1
        for y in lista_2:       #Para cada elemento de la lista_2
            if x == y:          #Comparo los elementos
                return True
    return False
...
def superposicion_in(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    for x in lista_1:           #Para cada elemento de la lista_1
        if x in lista_2:        #Comparo si el elemento esta en la lista_2
            return True
    return False
...
def superposicion_any(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    return any(elemento_1 in lista_2 for elemento_1 in lista_1 ) #Comparo si el elemento esta en la lista_2 Para cada elemento de la lista_1
...
def superposicion_set(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    if len(set(lista_1).intersection(set(lista_2))) > 0:    #Si la longitud de la intersección de los conjuntos es mayor a 0
        return True
    return False
